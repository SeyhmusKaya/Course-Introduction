...
<head>
	...
	<title>Sınava Hazırlık Programı</title>

	<meta name = "description" 
	content = "DEM Eğitim Kurumlarının Sınava Hazırlık programına bak.">
	<style type="text/css">
...
<body>
	<div class="container-fluid">
		...
		<div class="row d-flex justify-content-center">
			<div class="card col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3" style="">
				<div class="row">
					...
					<div class="content col-md-6 col-sm-12 col-lg-5 ">
						<h5 class="card-title text-monospace">Sınava Hazırlık Programı</h5>
						<h6 class="card-subtitle w-100 bg-watning"><a class="" href="<?php echo base_url("programlar/Sinava_hazirlik_programi");?>">#Sınava Hazırlık</a></h6>
						<h6 class="card-subtitle w-100 bg-primary" style="background-color:orange;"><a class="" href="<?php echo base_url("egitimlerimiz/Okul");?>">#Okul Eğitimlerimiz</a></h6>

						<hr>
						<div class="card-body " >
						 <p class="card-text">
							  7.ve 8.sınıf öğrencilerinin sınava hazırlık sürecinde, doğru teknikler kullanarak hızlı öğrenmelerine ve dikkat hatası yapmadan ideal bir sınav performansı sergilemelerine destek olacak bir eğitim programı hazırladık.
						 </p>
						 <?php if($this->session->has_userdata("user_is_login")){?>
							 <p class="card-text">
	Elbette sınava hazırlık öğrencisi olmak farklı bir çalışma mantığı ve özel bir disipline sahip olmayı gerektirir.
							 </p>
						 <?php }?>

						 <?php if(!$this->session->has_userdata("user_is_login")){?>
							 <a href="<?php echo base_url("kayit");?>" class="btn btn-primary reg-button" style="margin-top:7% !important;">Daha fazla bilgi için kaydol.</a>
						 <?php }?>
						</div>
					</div>
					<?php if($this->session->has_userdata("user_is_login")){?>
						<p class="card-text pl-4 pt-3">Bu hazırlık sürecinde öğrencilerin teknik becerileri, kondisyonu ve psikolojik durumu ideal konuma getirilmelidir.</p>
						<p class="card-text pl-4">Doğru tekniklerle hazırlanıldığında sınavlar stres kaynağı olmaktan çıkar ve öğrenciler ancak o zaman gerçek performanslarını sergileyebilirler.</p>
