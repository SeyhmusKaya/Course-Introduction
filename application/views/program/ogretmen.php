...
<head>
	...
	<title>Öğretmen Eğitimlerimiz</title>

	<meta name = "description" 
	content = "DEM Eğitim Kurumlarının Öğretmen Eğitimlerine bak.">
	<style type="text/css">
	...
	<div class="container-fluid">
		...
		<div class="row d-flex justify-content-center mt-1">
			<div class="card col-sm-12 col-md-8 col-lg-8 col-xl-8 mt-3 mb-2" style="">
				<div class="row">
					<img class="card-img-left crd-image col-md-12 col-md-12 col-lg-7" src="<?php echo base_url("assets/programs/13.png");?>" alt="Card image cap">
					<div class="content col-md-6 col-sm-12 col-lg-5 ">
						<h5 class="card-title text-monospace">Öğrenciyi Etkilemek</h5>
						<h6 class="card-subtitle w-100 ogretmen"><a class="" href="<?php echo base_url("egitimlerimiz/Ogretmen");?>">#Öğretmen Eğitimleri</a></h6>
						<hr>
						<div class="card-body " >
						 <p class="card-text" style="font-size:14px;">
							 Sınıftaki tüm öğrencilerin beğenisini kazanmak, sınıfın dersteki konsantrasyonunu arttırmak, dikkatleri ders boyunca üzerinde toplamak her öğretmenin ihtiyaç duyduğu bir beceridir.
						 <p class="card-text" style="font-size:14px;">
							 Doğru iletişim kanallarından, öğrencileri analiz ederek sunulan, gerektiği ölçüde ve doğru teknikle anlatılan bir ders, her öğrencinin zevkle dinleyeceği bir ders haline gelir.
 					   </p>

						 <?php if(!$this->session->has_userdata("user_is_login")){?>
							 <a href="<?php echo base_url("kayit");?>" class="btn btn-primary reg-button" style="margin-top:13% !important;">Daha fazla bilgi için kaydol.</a>
						 <?php }?>
						</div>
				 	</div>
				</div>
				<?php if($this->session->has_userdata("user_is_login")){?>
					<div class="mt-2 p-2 ml-3">
						<p class="card-text text-center mt-1 mb-3" style="font-size:14px;">
Özünde her öğretmenin ihtiyacı olan bu program; video kayıt ve içerik tasarlama desteği vererek, yeni nesil öğrenciler ile iletişim kurmaları için gerekli materyalleri sunarak, öğretmenlerin sınıfta sihirli bir etki yaratmasını sağlar.
		...
		<?php if($this->session->has_userdata("user_is_login")) {?>
			<div class="row d-flex justify-content-center">
				<div class="card col-sm-12 col-md-8 col-lg-8 col-xl-8 mt-3 mb-2" style="">
					<div class="row">
						<img class="card-img-left crd-image col-md-12 col-md-12 col-lg-7" src="<?php echo base_url("assets/programs/14.png");?>" alt="Card image cap">
						<div class="content col-md-6 col-sm-12 col-lg-5 ">
							<h5 class="card-title text-monospace">İyi Öğretmen Ne Yapar?</h5>
							<h6 class="card-subtitle w-100 ogretmen"><a class="" href="<?php echo base_url("egitimlerimiz/Ogretmen");?>">#Öğretmen Eğitimleri</a></h6>
							<hr>
							<div class="card-body " >
							 <p class="card-text" style="font-size:14px;">
2003 yılından bugüne kadar sunduğumuz eğitimlerde 7500'den fazla öğretmenimize bu soruyu sorduk; "İyi öğretmen ne yapar?".

							 </p>
							 <p class="card-text" style="font-size:14px;">
								 Aynı soruyu öğrencilerimize ve velilerimize de sorduk. Çıkan sonuçları biriktirdik, birbirine çok yakın cevapları eledik, harika bir veri havuzu elde ettik.
							 </p>
							 <p class="card-text" style="font-size:14px;">
Mesleki farkındalık anketlerimiz aracılığıyla gerçekleştirdiğimiz analizlerle, öğretmenlerimizin eğitim ihtiyaç analizlerini çıkartmaya devam ediyoruz.
 </p>
							</div>
						</div>
					</div>
					<div class="mt-2 p-2 ml-3">
						<p class="card-text text-center mt-1 mb-3" style="font-size:14px;">
Öğretmenlerimiz; 2 gün süren bu eğitimde bir yandan çok eğlenceli takım çalışmaları gerçekleştirip sunumlar hazırlarken, bir yandan da mesleki gerçekliklerini dürüstçe ortaya koyarak kendilerine katkı sağladıkları bu özel programa büyük bir keyifle katılmaktadırlar.
						</p>
