...
<head>
	...
	<title>Psikolojik Danışmanlık Programı</title>

	<meta name = "description" 
	content = "DEM Eğitim Kurumlarının Psikolojik Danışmanlık programına bak.">
	<style type="text/css">
	...
	<div class="container-fluid">
		...
		<div class="row d-flex justify-content-center mt-4">
			<div class="card col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3 mb-2" style="">
				<div class="row">
					<img class="card-img-left crd-image col-md-12 col-md-12 col-lg-7" src="<?php echo base_url("assets/programs/1.png");?>" alt="Card image cap">
					<div class="content col-md-6 col-sm-12 col-lg-5 ">
						<h5 class="card-title text-monospace">Psikolojik Danışmanlık Programı</h5>
						<h6 class="card-subtitle w-100"><a class="" href="<?php echo base_url("programlar/psikolojik_danismanlik_programi");?>">#Psikolojik Danışmanlık</a></h6>
						<hr>
						<div class="card-body " >
						 <p class="card-text">
							 Çocuğunuz ve kendiniz için ihtiyacınız olan konularda psikoloğumuza başvurabilirsiniz.
						 </p>
						 <?php if(!$this->session->has_userdata("user_is_login")){?>
							 <a href="<?php echo base_url("kayit");?>" class="btn btn-primary reg-button" style="margin-top:54% !important;">Daha fazla bilgi için kaydol.</a>
						 <?php }?>
						 <?php if($this->session->has_userdata("user_is_login")){?>
							 <a href="<?php echo base_url("Bize_ulasin");?>" class="btn btn-primary reg-button" style="margin-top:45% !important;">Daha detaylı bilgi için iletişime geçin size ulaşalım.</a>
						 <?php }?>
						</div>
				 	</div>
				</div>
