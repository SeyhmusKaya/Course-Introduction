...
<head>
	...
	<title>Seminerlerimiz</title>
	<meta name = "description" 
	content = "DEM Eğitim Kurumlarının seminerlerine bak.">
	<style type="text/css">
	...
	<div class="container-fluid">
		...
		<div class="row <?php if(!$this->session->has_userdata("user_is_login")){echo "d-flex justify-content-center mt-4";}?>">
			<div class="card col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3 mb-2" style="">
				<div class="row">
					<img class="card-img-left crd-image col-md-12 col-md-12 col-lg-7" src="<?php echo base_url("assets/programs/2.png");?>" alt="Card image cap">
					<div class="content col-md-6 col-sm-12 col-lg-5 ">
						<h5 class="card-title text-monospace pt-2">Seminerlerimiz</h5>
						<h6 class="card-subtitle w-100 bg-dark"><a class="" href="<?php echo base_url("programlar/seminerlerimiz");?>">#Seminerlerimiz</a></h6>
						<hr>
						<div class="card-body " >
						 <p class="card-text">
							 Yaşamlarının tüm dönemlerinde çocuklarının yanında olmak isteyen anne babalar, bu semineri kaçırmayın.
						 </p>
						 <p class="card-text">
							 Onların daha iyiye ve güzele ulaşması için hepimizin öğreneceği çok şey var.
						 </p>
						 <?php if(!$this->session->has_userdata("user_is_login")){?>
							 <a href="<?php echo base_url("kayit");?>" class="btn btn-primary reg-button" style="margin-top:30% !important;">Daha fazla bilgi için kaydol.</a>
						 <?php }?>
						</div>
				 	</div>
				</div>
			...
			<?php if($this->session->has_userdata("user_is_login")) {?>
				<div class="card col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3 mb-2" style="">
					<div class="row">
						<img class="card-img-left crd-image col-md-12 col-md-12 col-lg-7" src="<?php echo base_url("assets/programs/3.png");?>" alt="Card image cap">
						<div class="content col-md-6 col-sm-12 col-lg-5 ">
							<h5 class="card-title text-monospace pt-2">Seminerlerimiz</h5>
							<h6 class="card-subtitle w-100 bg-dark"><a class="" href="<?php echo base_url("programlar/seminerlerimiz");?>">#Seminerlerimiz</a></h6>
							<hr>
							<div class="card-body " >
							 <p class="card-text">
								 2005 yılından beri 125.000' den fazla öğrenci, hedeflerine ulaşmak için bu semineri izledi.
							 </p>
							 <p class="card-text">
								 Kurucumuz Zafer Polat KOYUNCU'nun aynı isimli televizyon programı ile öğrencilerine ulaştığı; hayalleri hedeflere, hedefleri gerçeklere dönüştürmenin yollarının anlatıldığı eğlenceli ve öğretici bir seminer.
							 </p>
				...
				<div class="row d-flex justify-content-center">
					<div class="card col-sm-12 col-md-6 col-lg-6 col-xl-6 mt-3 mb-2 " style="">
						<div class="row">
							<img class="card-img-left crd-image col-md-12 col-md-12 col-lg-7" src="<?php echo base_url("assets/programs/4.png");?>" alt="Card image cap">
							<div class="content col-md-6 col-sm-12 col-lg-5 ">
								<h5 class="card-title text-monospace pt-2">Seminerlerimiz</h5>
								<h6 class="card-subtitle w-100 bg-dark"><a class="" href="<?php echo base_url("programlar/seminerlerimiz");?>">#Seminerlerimiz</a></h6>
								<hr>
								<div class="card-body " >
								 <p class="card-text">
									 2006 yılından beri 200.000' den fazla öğrenci sınavlara bu seminer ile hazırlandı.
								 </p>
								 <p class="card-text">
									 Eğlenceli sınav hikayelerinin ve çok önemli sınav stratejilerinin anlatıldığı bu eğlenceli ve öğretici seminer, kurucumuz Zafer Polat KOYUNCU' nun aynı isimli kitabından uyarlanmıştır.
								 </p>
