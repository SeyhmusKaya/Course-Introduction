...
<head>
	...
	<title>Veli Eğitimlerimiz</title>
	<meta name = "description" 
	content = "DEM Eğitim Kurumlarının veli eğitimi programına bak.">
	...
	<div class="container-fluid">
		...
		<div class="row d-flex justify-content-center mt-1">
			<div class="card col-sm-12 col-md-8 col-lg-8 col-xl-8 mt-3 mb-2" style="">
				<div class="row">
					<img class="card-img-left crd-image col-md-12 col-md-12 col-lg-7" src="<?php echo base_url("assets/programs/15.png");?>" alt="Card image cap">
					<div class="content col-md-6 col-sm-12 col-lg-5 ">
						<h5 class="card-title text-monospace">Veli Eğitimlerimiz</h5>
						<h6 class="card-subtitle w-100 veli"><a class="" href="<?php echo base_url("egitimlerimiz/Veli");?>">#Veli Eğitimi</a></h6>
						<hr>
						<div class="card-body " >
						 <p class="card-text" style="font-size:14px;">
							 	Birlikte eğlenmek ve yaşayarak öğrenmek için hazırlanmış bu eğitime çocuklarınızla birlikte katılacaksınız.
			 			</p>
						 <p class="card-text" style="font-size:14px;">
								Çocuğunuzla birlikte öğrenmenin tadına varırken, onun sizinle bir paylaşımda bulunmaktan ne kadar çok keyif aldığını da net bir şekilde göreceksiniz.
						 </p>
						 <p class="card-text">Birlikte tamamen size özel tasarladığımız projelerle, öğrenmenin ve yaratıcılığın keyfini süreceğiniz harika bir eğitim programı.
						 </p>
						 <?php if(!$this->session->has_userdata("user_is_login")){?>
							 <a href="<?php echo base_url("kayit");?>" class="btn btn-primary reg-button" style="margin-top:5% !important;">Daha fazla bilgi için kaydol.</a>
						 <?php }?>
						</div>
				 	</div>
				</div>
				<?php if($this->session->has_userdata("user_is_login")){?>
					<div class="mt-2 p-2 ml-3 " style="font-size:15px;">
						<p class="card-text text-center mt-1">🔊 Anne, Baba, Çocuk Eğitim Programı</p>
						<p class="card-text text-center mt-1"><i class="fa fa-arrow-right" aria-hidden="true"></i>Omuz omuza öğrenme</p>
						<p class="card-text text-center mt-1"><i class="fa fa-arrow-right" aria-hidden="true"></i>İkimizin projesi.</p>
					</div>
				<?php }?>
		...
		<?php if($this->session->has_userdata("user_is_login")) {?>
			<div class="row d-flex justify-content-center">
				<div class="card col-sm-12 col-md-8 col-lg-8 col-xl-8 mt-3 mb-2" style="">
					<div class="row">
						<img class="card-img-left crd-image col-md-12 col-md-12 col-lg-7" src="<?php echo base_url("assets/programs/16.png");?>" alt="Card image cap">
						<div class="content col-md-6 col-sm-12 col-lg-5 ">
							<h5 class="card-title text-monospace">Her şey çocuğunuz için</h5>
							<h6 class="card-subtitle w-100 veli"><a class="" href="<?php echo base_url("egitimlerimiz/Veli");?>">#Veli Eğitimi</a></h6>
							<hr>
							<div class="card-body " >
							 <p class="card-text" style="font-size:14px;">
Çocuklarımız, tartışmasız olarak hayatımızın en değerli parçasıdır. Bu sebeple onlar için her zaman en iyi olanı bulmaya çalışırız. Ancak zaman zaman hepimiz, içinden çıkamadığımız ve neyin doğru olduğuna karar veremediğimiz durumlarla karşı karşıya kalırız.							 </p>
							 <p class="card-text" style="font-size:14px;">
Bu eğitim, ebeveynlerin tam olarak bu ihtiyacını karşılamak için tasarlanmıştır. Bizler çocuğunuzla etkili iletişim kurmanın, zihinsel ve psikolojik anlamda sağlıklı bireyler yetiştirmenin anahtarını bu eğitimde sizlere sunuyoruz.
					 		 </p>
							</div>
						</div>
					</div>
