...
<html lang="tr">
  ...
  <div class="container-fluid">
    ...
    <div class="row justify-content-center mt-3">
          <form class="form" action="<?php echo base_url()."admin/eventUpdateProcces";?>" method="post"  enctype="multipart/form-data">
            <div class="row">
              <div class="col form-group">
              <input type="text" name="head" value="<?php echo $view->header;?>" class="form-control form-control-lg box text-monospace" style="font-weight:bold;">
              </div>
            </div>
            <div class="row">
              <div class="col form-group">
                <textarea id="txtarea" class="box form-control" name="content" rows="15" cols="100" style="white-space: pre-wrap;" placeholder="Bir şeyler yaz."><?php echo $view->content;?></textarea>
              </div>
            </div>
            <div class="row form-group">
                <input type="text" name="id" value=<?php echo $view->id;?> hidden>
                <div class="col d-flex justify-content-center">
                  <input type="submit" name="submit" value="Düzenle" class="btn btn-primary box " style="padding-right: 20px !important;padding-left:20px;">
                </div>
            </div>
          </form>
        </div>
