...
<head>
	...
	content = "Dem Eğitim Kurumlarına giriş yap.">
...
<body>
	<div class="container-fluid">
		...
		<div class="row d-flex justify-content-center h-100" id="opac">
				<div class="user_card">
					<div class="d-flex justify-content-center">
						<div class="brand_logo_container">
							<img src=<?php echo base_url("assets/user-image.png");?> class="brand_logo" alt="Logo">
						</div>
					</div>
					<div class="d-flex justify-content-center form_container">
						<form action=<?php echo base_url("giris/sonucu")?> method="post">
							<div class="input-group mb-3">
								<div class="input-group-append">
									<span class="input-group-text"><i class="fas fa-user"></i></span>
								</div>
								<input type="email" name="email" class="form-control input_user" value="" placeholder="E-mail" required="required">
							</div>
							<div class="input-group mb-2">
								<div class="input-group-append">
									<span class="input-group-text"><i class="fas fa-key"></i></span>
								</div>
								<input type="password" name="password" class="form-control input_pass" value="" placeholder="Şifre" required="required">
							</div>
							<div class="form-group">
								<div class="custom-control custom-checkbox">
									<input type="checkbox" class="custom-control-input" id="customControlInline">
									<label class="custom-control-label" for="customControlInline" style="padding-top:3px;">Hatırla beni.</label>
								</div>
							</div>
							<div class=" mt-3 login_container">
					 			<button type="submit" name="button" class="btn login_btn">Giriş</button>
					   </div>

						</form>
					</div>
					<div class="text-center pt-1 text-monospace" style="font-size:17px; color:black; font-weight:bold;">
						<?php
						if(!empty($error)){
							echo $error;
						}
					...
					<div class="d-flex justify-content-center links">
						Hesabın yok mu? <a href=<?php echo base_url("kayit");?> class="ml-2">Kayıt ol</a>
					</div>
				</div>
		</div>
	</div>
