...
<head>
	...
	content = "Ne bekliyorsun hadi sende Dem Eğitim Kurumlarına kaydol!">
	...
	.signup-form form{
		...
		background: #f2f3f7;
		padding: 20px;
		-webkit-box-shadow: 0px 0px 7px -2px rgba(255,221,0,0.75);
		-moz-box-shadow: 0px 0px 7px -2px rgba(255,221,0,0.75);
		box-shadow: 0px 0px 7px -2px rgba(255,221,0,0.75);
	}
		...
		<div class="row ">
			<div class="col-sm-12 col-md-12 col-lg-12 ">
				<div class="signup-form mt-1">
				    <form action=<?php echo base_url("kayit/sonucu")?> class="w-100 " method="post">
						<h2 class=""style="color:orange">Ücretsiz Kaydol</h2>
						<p class="hint-text" >3 dakika gibi kısa bir sürede sende ücretsiz kaydolabilirsin.</p>
				        <div class="form-group">
									<div class="input-group-append" >
										<span class="input-group-text mr-2">	<i class="fa fa-address-book" aria-hidden="true"></i></span>
										<input type="text" class="form-control" name="name" placeholder="İsim ve Soyisim" required="required">
									</div>
				        </div>
				        <div class="form-group">
									<div class="input-group-append">
										<span class="input-group-text mr-2"><i class="fa fa-envelope" aria-hidden="true"></i></span>
										<input type="email" class="form-control" name="email" placeholder="E-mail" required="required">
									</div>
				        </div>
								<div class="form-group">
									<div class="input-group-append">
										<span class="input-group-text mr-2"><i class="fas fa-key"></i></span>
								...
								<div class="form-group">
									<div class="input-group-append">
										<span class="input-group-text mr-2"><i class="fas fa-key"></i></span>
										<input type="password" class="form-control" name="confirm_password" placeholder="Şifreyi Doğrula" required="required">
									</div>
				        </div>
								<div class="form-group w-100">
									<div class="row ">
										<div class="col-3" style="padding-right:0px !important;">
											<select class="custom-select form-control" style="max-width: 70px;">
													<option selected="">+90</option>
											</select>
										</div>
										<div class="col-9"  style="padding-left:0px !important;">
											<input name="phone" class="form-control" placeholder="Telefon Numarası" type="text" required="required">
										</div>
									</div>
								</div>
								<div class="form-group">
									<label for="date" style="margin-left:3px;">Doğum Tarihiniz(Gün/Ay/Yıl)</label>
									<div class="input-group-append">
										<span class="input-group-text mr-2"><i class="fa fa-calendar" aria-hidden="true"></i></span>
										<input id="date" name="date" type="date" class="datepicker form-control" required="required">
									</div>
								</div>
								<div class="form-group">
				            <button type="submit" class="btn btn-primary btn-lg btn-block">Kaydol</button>
				        </div>
								<div class="text-center text-danger" id="text-error">
									<?php
									if(!empty($error)){
										echo "<h6>$error</h6>";
									}
								...
								<div class="text-center">Zaten hesabın var mı? <a href=<?php echo base_url("giris")?>>Giriş Yap</a></div>
				    </form>
				</div>
			</div>
