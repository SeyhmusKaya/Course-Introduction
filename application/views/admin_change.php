  ...
  <div class="container-fluid">
    ...
    <div class="row mt-5  d-flex justify-content-center">
      ...
      <div class="col-md-8 col-sm-12 col-lg-6 col-xl-5">
        <h1 class="text-center font-weight-bold text-monospace border-bottom">Bilgileri Değiştir  </h1>
        <br>
        <form action=<?php echo base_url()."admin/changeProcces"?> method="post">
          ...
          <div class="text-center">
            <button type="submit" class="btn btn-outline-dark px-5 py-3" name="button"> Değiştir </button>
          </div>
        </form>
      </div>
